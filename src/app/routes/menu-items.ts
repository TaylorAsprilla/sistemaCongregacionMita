...
export enum RUTAS {
  ...
  CREAR_TIPO_ACTIVIDAD_ECONOMICA = 'tipo-actividad-economica',
  ...
  CENSO = 'censo',
  DASHBOARD_OBRERO = 'dashboard/obrero',
  EVENTOS = 'eventos',
  EVENTOS_EN_VIVO = 'eventos-en-vivo',
  GENERAR_QR = 'generar-qr',
  GRUPO_GEMELOS = 'grupo-gemelos',
  HOME = '/#/sistema/inicio',
  INICIO = 'inicio',
  INFORME = 'informe',
